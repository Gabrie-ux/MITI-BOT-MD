...
console.log('🍭 MITIBOT-ST no tiene Sub-Bots vinculados.');
return;
}
...
const mainBotAuthFile = 'MITIBOTSession';
try {
const mainBot = await connectionUpdate(mainBotAuthFile);
global.conns.push(mainBot);
console.log(chalk.bold.greenBright(`🚀 MITIBOT conectado correctamente.`))
